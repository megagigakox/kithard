        ...
        this.achievements.put(
                ...
                Arrays.asList(
                        ...
                        Achievement.builder()
                                ...
                                .reward(AchievementReward.builder()
                                        .friendlyName("5x Kox")
                                        .itemStack(ItemStackBuilder.of(new ItemStack(Material.GOLDEN_APPLE, 5)).asItemStack())
                                        .build())
                                .required(50000)
                                .build(),
                        Achievement.builder()
                        ...
                        Achievement.builder()
                                ...
                                .reward(AchievementReward.builder()
                                        ...
                                        .itemStack(ItemStackBuilder.of(new ItemStack(Material.GOLDEN_APPLE, 32)).asItemStack())
                                        .build())
                                .required(500000)
                                .build(),
                        Achievement.builder()
