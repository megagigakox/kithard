...
public class BossService {
    ...
    public void createBoss(Location location, int hp) {
        this.boss = (Zombie) Bukkit.getWorld("world").spawnEntity(location, EntityType.ZOMBIE);
        boss.setCustomName(TextUtil.color("&3&lWujek Władek"));
    ...
    public void setBoss(Zombie boss) {
        this.boss = boss;
    }
}
