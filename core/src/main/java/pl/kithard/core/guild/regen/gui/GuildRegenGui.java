...
public class GuildRegenGui {
    ...
    public void open(Player player, Guild guild) {
        ...
        LinkedList<GuildRegenBlock> regenBlocks = guild.getRegenBlocks();
        ...
        gui.setItem(3, 5, itemStackBuilder.asGuiItem(event -> {
            ...
            new GuildRegenTask(this.plugin, new LinkedList<>(guild.getRegenBlocks()), player.getUniqueId(), guild);
